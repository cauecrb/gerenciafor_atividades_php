...
$php = Start-Process powershell -ArgumentList "-NoExit","-Command","php artisan serve --host=127.0.0.1 --port=$Port" -PassThru -WorkingDirectory (Split-Path $PSScriptRoot -Parent)
...
Write-Output "Backend http://127.0.0.1:$Port"
